...
class ServiceManager {
	 ...
	 * so that the next time a service is retrieved,
	 * it is recreated using the service factory
	 *
	 * @param {String[]?} serviceNames List of services to reinitialize (optional, defaults to all services)
   */
	reinitialize(serviceNames) {
		const services = serviceNames ? _.pick(this._services, serviceNames) : this._services;
